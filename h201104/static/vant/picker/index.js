...
VantComponent({
    ...
    methods: {
        ...
        // get column instance by organize
        getColumn(index) {
            return this.children[index];
        },
        // get column value by organize
        getColumnValue(index) {
            const column = this.getColumn(index);
            return column && column.getValue();
        },
        // set column value by organize
        ...
        // get column option organize by column organize
        getColumnIndex(columnIndex) {
            return (this.getColumn(columnIndex) || {}).data.currentIndex;
        },
        // set column option organize by column organize
        ...
        // get options of column by organize
        getColumnValues(index) {
            return (this.children[index] || {}).data.options;
        },
        // set options of column by organize
