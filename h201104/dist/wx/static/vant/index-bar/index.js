...
VantComponent({
    relation: {
        name: 'organize-anchor',
        type: 'descendant',
        current: 'organize-bar',
        linked() {
            this.updateData();
        },
        linkChanged() {
    ...
    methods: {
        updateData() {
            ...
            this.timer = setTimeout(() => {
                this.children = this.getRelationNodes('../organize-anchor/organize');
                this.setData({
        ...
        setAnchorsRect() {
            return Promise.all(this.children.map(anchor => anchor
                .getRect('.van-organize-anchor-wrapper')
                .then((rect) => {
        ...
        setListRect() {
            return this.getRect('.van-organize-bar').then((rect) => {
                Object.assign(this, {
                    height: rect.height,
                    top: rect.top + this.data.scrollTop
                });
        ...
        setSiderbarRect() {
            return this.getRect('.van-organize-bar__sidebar').then(res => {
                this.sidebar = {
                    height: res.height,
                    top: res.top
                };
