 ...
 * 分享 ID
 * */
export const PROJECT_ID = "h200729";
export const SHARE_ID = "h_200729";
...
export const PROJECT_INTERFACE = {
    ...
    get_video_grouping: 'get_video_grouping',
    get_curriculum_video_list: 'get_curriculum_video_list'
};
